...
pdf("output/Gurue_2014_OTU.pdf")
heatmap.2(M,col=colfunc(15), main = "Gurue 2014 OTUs",dendrogram = "none", srtCol=360,  adjCol = c(0.5,0.5), scale="column", trace="none", key = F, denscol="black", cexRow=0.5, cexCol =0.8, margins = c(8,16))
...
heatmap.2(M, main = "Gurue 2014 OTUs", col=bluered, dendrogram = "none", srtCol=360,  adjCol = c(0.5,0.5), scale="column", trace="none", key = F, denscol="black", cexRow=0.5, cexCol =0.8, margins = c(8,16))
